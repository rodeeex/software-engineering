...
![[Pasted image 20260116223407.png]]
...
![[Pasted image 20260116230116.png]]

- **Требования к хранению:**
  - PostgreSQL для основных данных;
  - Redis для кэша;
  - ежедневное резервное копирование основных данных.
- **Требования к целостности:**
  - валидация e-mail, пароля, структуры подборов (блоки, разметка);
  - ссылочная целостность в БД.
